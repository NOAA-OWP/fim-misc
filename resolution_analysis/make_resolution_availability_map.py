...
if __name__ == "__main__":
    ...
    regions_fns = [
        os.path.join(data_dir, 'huc8s_sp.gpkg'),
        os.path.join(data_dir, 'benchmarks_sp.gpkg')
    ]

    tile_index_1m_fn = os.path.join(data_dir, 'lidar_tile_index', 'usgs_rocky_3dep_1m_tile_index_20240612.gpkg')
    tile_index_3m_fn = os.path.join(data_dir, 'lidar_tile_index', 'usgs_rocky_3dep_3m_tile_index_20240612.gpkg')
